...
<head>
    ...
    <meta name="description" content="PT. Sagara Berkah Marine">
    <meta name="author" content="PT. Sagara Berkah Marine">
    <meta name="keywords" content="Sagara Berkah Marine,Sagara Berkah Marine, integrated logistics services,comprising door to door distribution,warehousing,staffing stripping,trucking,custom clearance,one stop shipping,PT. Sagara Berkah Marine">
    ...
    <meta property="og:site_name" content="PT. Sagara Berkah Marine">
    <meta property="og:title" content="PT. Sagara Berkah Marine">
    <meta property="og:description" content="Sagara Berkah Marine">
    <meta property="og:keywords" content="Sagara Berkah Marine,Sagara Berkah Marine Indonesia,integrated logistics services,comprising door to door distribution,warehousing,staffing stripping,trucking,custom clearance,one stop shipping,PT. Sagara Berkah Marine">
    <!-- Image to display -->
    <!-- Replace   «example.com/image01.jpg» with your own -->
    <meta property="og:image" content="https://doqumentasi.id/sbm/assets/images/logo/sbm-logo.png">
    ...
    <meta property="og:url" content="https://sbm.co.id">

    <title>PT. Sagara Berkah Marine</title>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/navhighlight.css">
    <!-- jquery -->
...
<body>
    ...
    <!-- navbar area start -->
    <nav class="navbar navbar-area navbar-expand-lg black nav-style-01 header-style-09 nav-fixed">
            ...
            <div class="collapse navbar-collapse" id="appside_main_menu">
                ...
                <ul class="navbar-nav">
                    <li class="current-menu-item">
                        <a class="p-2" id="idHome" data-target="home" href="<?= base_url() ?>#home"><?= $this->lang->line('home') ?></a>
                    </li>
                    <li><a class="p-2" id="idServices" data-target="services" href="<?= base_url() ?>#services"><?= $this->lang->line('service') ?></a></li>
                    <li><a class="p-2" id="idProfile" data-target="profile" href="<?= base_url() ?>#profile"><?= $this->lang->line('profile') ?></a></li>
                    <li><a class="p-2" id="idGallery" data-target="gallery" href="<?= base_url('gallery') ?>"><?= $this->lang->line('gallery') ?></a></li>
                    <li><a class="p-2" id="idContact" data-target="contact" href="<?= base_url() ?>#contact"><?= $this->lang->line('contact') ?></a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-inner">
                            ...
                            <div class="left-content-area" style="/*color:black*/">
                                <!-- left content area -->
                                &copy; Copyrights 2020 PT. Sagara Berkah Marine
    ...
    <script src="<?= base_url() ?>assets/navhighlight.js"></script>
</body>
